...
class FormPasswdInput extends React.Component {

    static buildData( props ) {

        const input = props.hasOwnProperty( 'input' ) ? props.input : FormPasswdInput.defaultProps.input;
...
FormElements['password'] = FormPasswdInput;

Object.assign( FormPasswdInput.defaultProps, css );
